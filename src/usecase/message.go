...
func NewMessageService(chatStorageRepo domainChatStorage.IChatStorageRepository, tenantProvider domainTenant.TenantProvider) domainMessage.IMessageUsecase {
