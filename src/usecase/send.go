...
func NewSendService(appService app.IAppUsecase, chatStorageRepo domainChatStorage.IChatStorageRepository, tenantProvider domainTenant.TenantProvider) domainSend.ISendUsecase {
    return &serviceSend{
